 ...
 * @author Enrique
 */
public final class Funcion extends javax.swing.JInternalFrame {

    /**
     * Creates new form pais
     */
    private Colecciones.Funciones objfunciones;
    private bean.Funcion objfuncion;
    ...
    public Funcion() {
        try {
            objfunciones = new Colecciones.Funciones();
        } catch (Exception e) {
        }
        initComponents();
        cargar();
    ...
    public void cargar() {
        try {
            objfunciones.actualizar();
        } catch (Exception e) {
        }

        int filas = jTFuncion.getRowCount();
        for (int i = 0; i < filas; i++) {
            ((javax.swing.table.DefaultTableModel) jTFuncion.getModel()).removeRow(0);
        }

        for (bean.Funcion obj : objfunciones) {
            ((javax.swing.table.DefaultTableModel) jTFuncion.getModel()).addRow(new Object[]{obj.getId(), obj.getDescripcion()});
        }
    }
    ...
    private void initComponents() {
        ...
        if (jTFuncion.getColumnModel().getColumnCount() > 0) {
            jTFuncion.getColumnModel().getColumn(0).setMaxWidth(50);
        }
    ...
    private void jBnuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBnuevoActionPerformed
        ...
        switch (jBnuevo.getText()) {
            ...
            case "Guardar":
                ...
                objfuncion.setId(Integer.parseInt(jtxtcodigo.getText()));
                objfuncion.setDescripcion(jtxtdescripcion.getText());
    ...
    private void jTFuncionMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTFuncionMouseClicked
        jBsalir.setText("Cancelar");
        if (evt.getButton() == 1) {
            int codigo = Integer.parseInt(String.valueOf(jTFuncion.getValueAt(jTFuncion.getSelectedRow(), 0)));
            activar();
    ...
    private void jBeliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBeliminarActionPerformed
        ...
        objfuncion = new bean.Funcion();
        objfuncion.setId(Integer.parseInt(jtxtcodigo.getText()));
        jtxtcodigo.setText(String.valueOf(objfuncion.getId()));
        objfuncion.eliminar();
        desactivar();
        cargar();
        jBnuevo.setText("Nuevo");
